...
<!--           Innercontent-->
         <div id="innercontent">
                 <div class="introtext">
                     ...
                     <h2>"Where Puff-up and Puff-in represents our version of the usual signup and signin you'd find elsewhere"</h2>
                     <h3 style="text-align: center; color: #5bc0de; font-weight: bold;">---Puff Lord</h3>
                     </blockquote>
                 </div>
                <h2 style="color: red; width: 60%; text-align: center; margin: auto; background: rgba(20, 30, 30, 0.4)" >Now that you are here, look around and drop a comment on how you'd like us to improve. Thanks!</h2>
                <div style="width: 100%; display: block;">
<!--                Midpage signup button-->
                    <button class="btn btn-lg btn-info crazy" style="border-radius: 20px; display: block; margin: auto;" data-target="#puffupmodal" data-toggle="modal">Click here to Puff-up, it's free</button>
                    <br>
                </div>
                 <div class="yepa" style="margin: auto; width: 60%; color: white; font-weight: bold;">
                    <h3 >Here are a few more stuffs to try out;</h3>
                     <ul>
                         <li>Try the navigation buttons out</li>
                         <li>Drop a comment and test the comment features out</li>
                         <li>Puff-in and update your profile infos</li>
                         <li>Use the puff-box :)</li>
                     </ul>
                 </div>
        </div>
<!-- Puffup Jumbotron       -->
...
<!--                         error messages from php-->
                       ...
                       <div class="modal-footer" style="text-align: center;">
                           <input type="submit" name="resetpassword" value="Reset my password" class="btn btn-info">
            ...
            <div class="modal" id="dudee" role="dialog" aria-labelledby="dudeModalLabel" aria-hidden="true">
               <div class="modal-dialog">
                   <div class="modal-content">
                       ...
                       <div class="modal-body">
                           <h4 id="forgottenpasswordmodallabel" style="font-weight=bold; text-align: center;">Calm your titties!!! Gotta be a Puffer to be able to drop comments here.</h4>  
                       </div>
                       <div class="modal-footer" style="text-align: center;">
